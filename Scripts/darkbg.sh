...
sed -ie 's/*.color10:      #469e4a/*.color10:      #65BB69/g' ~/.Xresources
sed -ie 's/*.color3:       #fb8c00/*.color3:       #FAB406/g' ~/.Xresources
sed -ie 's/*.color11:      #ef6c00/*.color11:      #EED500/g' ~/.Xresources
sed -ie 's/*.color4:       #1976D2/*.color4:       #1562AF/g' ~/.Xresources
sed -ie 's/*.color12:      #0c5f9a/*.color12:      #0C82E0/g' ~/.Xresources
sed -ie 's/*.color5:       #9575CD/*.color5:       #7E58C2/g' ~/.Xresources
sed -ie 's/*.color13:      #886cbc/*.color13:      #9C80D0/g' ~/.Xresources
sed -ie 's/*.color6:       #00897B/*.color6:       #007468/g' ~/.Xresources
sed -ie 's/*.color14:      #359188/*.color14:      #409C93/g' ~/.Xresources
