...
sed -ie 's/*.color10:      #65BB69/*.color10:      #81C784/g' ~/.Xresources
sed -ie 's/*.color3:       #FAB406/*.color3:       #FBC02D/g' ~/.Xresources
sed -ie 's/*.color11:      #EED500/*.color11:      #FFEB3B/g' ~/.Xresources
sed -ie 's/*.color4:       #1562AF/*.color4:       #1976D2/g' ~/.Xresources
sed -ie 's/*.color12:      #0C82E0/*.color12:      #2196F3/g' ~/.Xresources
sed -ie 's/*.color5:       #7E58C2/*.color5:       #9575CD/g' ~/.Xresources
sed -ie 's/*.color13:      #9C80D0/*.color13:      #B39DDB/g' ~/.Xresources
sed -ie 's/*.color6:       #007468/*.color6:       #00897B/g' ~/.Xresources
sed -ie 's/*.color14:      #409C93/*.color14:      #4DB6AC/g' ~/.Xresources
